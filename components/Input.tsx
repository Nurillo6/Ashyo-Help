...
const Input:React.FC<InputType> = ({type, placeholder, extraClass, onChange, onBlur, name}) => {
  ...
  return (
    ...
    <div className='relative'>
      <input required name={name} onBlur={onBlur} onChange={onChange} className={`${extraClass} focus:shadow focus:shadow-[#134E9B] duration-300 bg-[#EBEFF3] w-full outline-none py-[17px] px-[26px] rounded-[6px] text-[14px] leading-[#EBEFF3]`} type={showPass ? "text" : "password"} placeholder={placeholder} autoComplete='off' />
